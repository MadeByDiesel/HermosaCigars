...
function av_get_verify_form() {
	...
	switch ( $input_type ) {
		...
		case 'checkbox' :
			...
			$form .= '<p class="text-center"><label for="av_verify_confirm"><input type="checkbox" name="av_verify_confirm" id="av_verify_confirm" value="1" /> ';
	...
	$form .= '<p class="submit text-center">';
